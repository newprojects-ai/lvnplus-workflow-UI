/*
  # Update User Schema and Workflow Relations
  
  1. Changes
    - Creates users view from auth.users
    - Adds user profiles table
    - Updates workflow created_by column to UUID
    - Adds audit logging
    
  2. Security
    - Enables RLS on new tables
    - Updates existing policies to work with UUID type
    - Adds proper user-based policies
*/
...
DROP POLICY IF EXISTS "Transitions are editable by workflow creators" ON workflow_transitions;
