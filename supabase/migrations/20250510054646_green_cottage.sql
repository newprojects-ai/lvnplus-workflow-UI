...
DROP POLICY IF EXISTS "Variables are editable by workflow creators" ON workflow_variables;
DROP POLICY IF EXISTS "Error handlers are editable by workflow creators" ON workflow_error_handlers;
